...
<head>
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
		<a class="navbar-brand" href="index.jsp">세종대학교 강의평가 웹 사이트</a>
      ...
      <div class="card bg-light mt-3">
        ...
        <div class="card-header bg-light">
          ...
          <div class="row">
            ...
            <div class="col-8 text-left">컴퓨터개론&nbsp;<small>XXX교수님</small></div>
      ...
      <div class="card bg-light mt-3">
        ...
        <div class="card-header bg-light">
          ...
          <div class="row">
            ...
            <div class="col-8 text-left">컴퓨터그래픽스&nbsp;<small>XXX교수님</small></div>
        ...
        <div class="card-body">
          ...
          <h5 class="card-title">
            ...
            나쁘지 않은 것 같습니다.&nbsp;<small>(2020년 여름학기)</small>
      ...
      <div class="card bg-light mt-3">
        ...
        <div class="card-header bg-light">
          ...
          <div class="row">
            ...
            <div class="col-8 text-left">알고리즘&nbsp;<small>XXX교수님</small></div>
        ...
        <div class="card-body">
          ...
          <h5 class="card-title">
            ...
            강의력이 제일 좋은 강의입니다.&nbsp;<small>(2020년 2학기)</small>
              ...
              <div class="form-row">
                ...
                <div class="form-group col-sm-4">
                  ...
                  <select name="semesterDivide" class="form-control">
                    ...
                    <option name="여름계절학기">여름계절학기</option>

                    <option name="2학기">2학기</option>

                    <option name="겨울계절학기">겨울계절학기</option>
